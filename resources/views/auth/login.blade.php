            ...
            <div class="signin-signup">
                    ...
                    <div class="input-field"> <i class="fas fa-user"></i>
                        ...
                        <span class="invalid-feedback" role="alert">
                                        <strong class="text-nowrap">{{ $message }}</strong>
                                    </span>
                        @enderror
                    </div>
                    ...
                    <div class="input-field"> <i class="fas fa-user"></i>
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="User Name" autocomplete="name" autofocus>
...
{{--    </div>--}}
{{--</div>--}}
    {{--original login form stop--}}



{{--    original register form start--}}
{{--    <div class="container">--}}
{{--        <div class="row justify-content-center">--}}
{{--            <div class="col-md-8">--}}
{{--                <div class="card">--}}
