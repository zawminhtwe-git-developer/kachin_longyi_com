    ...
    <style>
        ...
        * {
        ...
        .social-icon {
            ...
            border-radius: 50%;
            border: 1px solid #a47ace;
            text-decoration: none;
            font-size: 1.1rem;
            transition: 0.3s;
            background-image: linear-gradient(-45deg, #ad35f8 0%, #04affe 100%);
        }
...
{{--              ***************************************************************************************************************************************  Register Start--}}
                <form action="{{route('register')}}" method="post" class="sign-up-form">
                    ...
                    <input type="submit" class="btn" value="Regiester"/>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <button class="btn transparent" id="sign-up-btn">Regiester</button>
                </div>
                <img src="log.svg" class="image" alt=""/></div>
            <div class="panel right-panel">
                <div class="content">
                    <h3>One of us ?</h3>
                    <p>
                    Kachinlongyi.com မှ ဝယ်ယူသော ပစ္စည်းများကို သက်ဆိုင်ရာ မြို့နယ်အသီးသီးသို့ စာတိုက်မှလည်းကောင်း၊ ကားဂိတ်မှလည်းကောင်း ပို့ဆောင်ပေးလျက် ရှိနေပြီဖြစ်ပါသည်။ Kachinlongyi.com မှဝယ်ယူသော ပစ္စည်းများကို ငွေပေးချေရာတွင် KBZ Pay၊ Wave Money Pay၊ Myanmar Economic Bank တို့မှလည်း ပေးချေနိုင်ပြီဖြစ်ပါသည်။
                    </p>
                    <button class="btn transparent" id="sign-in-btn">Log in</button>
                </div>
                <img src="register.svg" class="image" alt=""/></div>
        </div>
    </div>
