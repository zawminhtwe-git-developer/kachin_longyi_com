...
@section('content')
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{asset("images/logo/profile real.jpg")}}" style="max-height: 500px; object-fit:fill"
                             class="d-block w-100 shadow-lg text-center" alt="...">
                        {{--                                <img src="{{ asset('images/logo/profile real.jpg') }}"--}}
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset("images/logo/profile real.jpg")}}" style="max-height: 500px;object-fit: fill"
                             class="d-block w-100 text-center" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset("images/logo/profile real.jpg")}}" style="max-height: 500px;object-fit: fill"
                             class="d-block w-100 text-center" alt="...">
    ...
    <div class="row justify-content-between custom-margin p-1" id="card-style">
        @foreach(\App\Models\Post::latest()->get() as $item)
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-3 d-flex align-items-stretch p-1">
                    ...
                    <div class="">
                        <a class="venobox" data-gall="img{{ $item->id }}"
                           href="{{asset('storage/product_photo/'.$item['gallery'])}}">
                            <img src="{{asset('storage/product_photo/'.$item['gallery'])}}" class="w-100 card-img-top animate__animated animate__bounce zoom"
                                 style="height: 100%;" alt="image alt"/>
                        </a>

                    </div>
                    <div class="card-body">
                        <h6 class="card-title text-center" style="color: var(--body-color)">"{{$item['name']}}"</h6>
                        <hr class="m-0 p-0 mb-2">
                        <h6>Price - (<i><b>{{$item['sale_price']}}</b></i>) MMK</h6>
                        <hr class="m-0 p-0 mb-2">
                        <p class="card-text" style="text-align: justify;letter-spacing: 1px;text-indent: 15px">
                            {{\Illuminate\Support\Str::substr($item['description'],0,50)}}.... <a
                                href="{{route('welcome-detail',$item->id)}}" class="text-black-50"><small>read
                                    more</small></a>
                        </p>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                       <button class="btn btn-sm"> <a href="{{route('welcome-detail',$item->id)}}" style="color: var(--body-color)">Detail</a></button>
                        <form action="{{route("cart.store")}}" method="POST">
                            @csrf
                            <input type="hidden" name="post_id" value="{{$item['id']}}">
                            <button
                                class="btn btn-sm text-nowrap align-items-center rounded-circle">
                                <i class="fas fa-cart-plus" style="color: var(--body-color)"></i></button>
                        </form>
                    </div>
                </div>
            </div>
