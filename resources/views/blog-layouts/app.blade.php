...
<head>
    ...
    <meta property="twitter:description" content="'Sein Sein' Kachinlongyi.com Website သည် Customers များကို (၁၀၀%) ဝန်ဆောင်မှုပေးသော Online Shopping တစ်ခုဖြစ်ပါသည်။ Kachinlongyi.com မှ ဝယ်ယူသော ပစ္စည်းများကို သက်ဆိုင်ရာ မြို့နယ်အသီးသီးသို့ စာတိုက်မှလည်းကောင်း၊ ကားဂိတ်မှလည်းကောင်း ပို့ဆောင်ပေးလျက် ရှိနေပြီဖြစ်ပါသည်။ Kachinlongyi.com မှဝယ်ယူသော ပစ္စည်းများကို ငွေပေးချေရာတွင် KBZ Pay၊ Wave Money Pay၊ Myanmar Economic Bank တို့မှလည်း ပေးချေနိုင်ပြီဖြစ်ပါသည်။">
                ...
                <ul class="nav-links text-uppercase">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="#" class="nocolor text-nowrap">Longyi Kwin</a>
                            <a href="#" class="nocolor text-nowrap"></a>
                            <a href="#" class="nocolor text-nowrap">Link 3</a>
                            <a href="#" class="nocolor text-nowrap">Link 1</a>
                            <a href="#" class="nocolor text-nowrap">Link 2</a>
                            <a href="#" class="nocolor text-nowrap">Link 3</a>
                            <a href="#" class="nocolor text-nowrap">Link 3</a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropbtn">Porfolio</a>
                        <div class="dropdown-content">
                            <a href="#" class="nocolor text-nowrap">Link 1</a>
                            <a href="#" class="nocolor text-nowrap">Link 2</a>
                            <a href="#" class="nocolor text-nowrap">Link 3</a>
                            ...
                            @if (Route::has('login'))
                                ...
                                @auth
                                    <a href="{{ url('/home') }}" class="nocolor text-nowrap"
                                       class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
                                @else
                                    <a href="{{ route('login') }}" class="nocolor text-nowrap"
                                       class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="nocolor text-nowrap"
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="#" class="nocolor text-nowrap">တိုက်ရိုက်ဆက်သွယ်မည်</a>
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ url('/home') }}" class="nocolor text-nowrap"
                                       class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
